...
///
/// <tt>UIColor</tt> has an initializer called <tt>-initWithRed:green:blue:alpha:</tt> that accepts its color component parameters as
/// percentages (i.e., between the values 0.0 and 1.0). This method transforms its parameters to the correct percentages and calls
/// <tt>-initWithRed:green:blue:alpha:</tt> using them. An alpha value of 1.0 is used.
///
